...
export class RightContent extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h1 className='heading-register'>User Registeration</h1>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="email" value={email} name="email" onChange={(e) => { this.inputChange(e)} } className="form-control" id="email" placeholder="example@gmail.com" />
